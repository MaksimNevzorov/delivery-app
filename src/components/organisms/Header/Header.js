    ...
    <div class="container-fluid justify-content-end" >
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav  mb-2 mb-lg-0">
                <li class="nav-item">
                  <it-link to='${appRoutes.home}' classname='header-link' title="">Главная страница</it-link>
                </li>
                <li class="nav-item">
                  <it-link to='${appRoutes.admin}' classname='header-link' title="">Загрузить</it-link>
                </li>
                <li class="nav-item">
                  <it-link to='${appRoutes.signUp}' classname='header-link' title="">Регистрация</it-link>
                </li>
                <li class="nav-item">
                  <it-link to='${appRoutes.signIn}' classname='header-link' title="">Войти</it-link>
                </li>
                <li class="nav-item dropdown">
                    <span class="nav-link btn-secondary dropdown-toggle show" role="button" data-bs-toggle="dropdown" aria-expanded="true">
                    <img src="./assets/images/cart.svg" alt="Bootstrap" width="30" height="24">
                    </span>
